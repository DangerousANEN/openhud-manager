...
(function () {
  ...
  function renderCam(snap) {
    ...
    // Live Webcam mode check (URL param ?cam=live or localStorage)
    var isLiveCam = window.location.search.includes('cam=live') || localStorage.getItem('cam_mode') === 'live';
    wrapEl.classList.toggle('live-cam', isLiveCam);
