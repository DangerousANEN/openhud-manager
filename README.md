...
- 📖 **[Руководство оператора (OPERATOR-GUIDE.ru.md)](docs/OPERATOR-GUIDE.ru.md)** — полное практическое руководство по установке, подключению CS2 (наблюдатель/GSI), интеграции с OBS Studio, настройке веб-камер игроков и решению проблем.
- Полный архив технической документации — в [docs/](docs/): архитектура, GSI, редактор HUD, устранение неполадок.
